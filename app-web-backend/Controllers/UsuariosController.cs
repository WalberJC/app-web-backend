...
namespace app_web_backend.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Login([Bind("Id,Senha")] Usuario usuario)
        {
            ...
            bool isSenhaOk = BCrypt.Net.BCrypt.Verify(usuario.Senha, user.Senha); // se o usuário existe, eu pego a senha que ele passou e comparo se é a mesma que esta no banco de dados
